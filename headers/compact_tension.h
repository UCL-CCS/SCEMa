namespace HMM {
	...
	class CompactTension: public ProblemType<dim>
	{
			...
			CompactTension (boost::property_tree::ptree input)
      {
        ...
        calculi_B = input_config.get<double>("problem type.calculi_B");
        calculi_a = input_config.get<double>("problem type.calculi_a");
        calculi_t = input_config.get<double>("problem type.calculi_t");
      }
